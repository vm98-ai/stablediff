...
class Diffusion(nn.Module):
    def __init__(self):
        self.time_embedding = TimeEmbedding(320)    # gives the time at which noise is added
        self.unet = UNET()
    ...
    def forward(self, latent: torch.Tensor, context: torch.Tensor, time: torch.Tensor):
        ...
        # time : (1,320)
        # (1,320) -> (1,1280)
        time = self.time_embedding(time)   # kind of gives positional information ie where the model is currently at
